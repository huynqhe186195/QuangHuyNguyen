...
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"> 
      ...
      .carousel-item:nth-child(1) {
        background-image: url('https://supersports.com.vn/cdn/shop/files/HOKA_-_Speedgoat_6_1545x500_V.jpg?v=1720688337&width=1920');
                        ...
                        <div id="content" class="row">
                            <div class=" col-12 col-md-12 col-lg-6">
                                    <div class="card-body">
                                        ...
                                        <h2 class="card-title show_txt" style="text-align:center; font-size:24pt;">SoleMates</h2>
                            ...
                            <div class=" col-12 col-md-12 col-lg-6">
                                    <img class="card-img-top" src="https://th.bing.com/th/id/OIP.2pKZEBMA32muy0fKoAVfRwHaFj?rs=1&pid=ImgDetMain" alt="Card image cap">        
                            </div>
                    </div>
                </div>
            </div>
