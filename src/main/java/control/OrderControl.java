		...
		try {
			...
			String deliveryAddress = request.getParameter("deliveryAddress");
			 ...
			 HttpSession session = request.getSession();
				...
				email.setFrom("huyasus2852@gmail.com");
				email.setFromPassword("dprrejikzemgawpy");
				email.setTo(emailAddress);
				email.setSubject("Dat hang thanh cong tu SoleMates");
				StringBuilder sb = new StringBuilder();
				sb.append("Dear ").append(name).append("<br>");
				sb.append("Ban vua dat dang tu Shop Ban Giay Cua Chung Toi. <br> ");
				...
				sb.append("Cam on ban da dat hang tai SoleMates Shop<br>");
